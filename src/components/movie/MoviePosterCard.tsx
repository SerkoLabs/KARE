...
type MoviePosterCardProps = {
  ...
  onPress?: ((movieId: string) => void) | undefined;
};

export function MoviePosterCard({ movie, onPress }: MoviePosterCardProps) {
  return (
    <Pressable
    ...
    >
      <PosterSurface title={movie.title} uri={movie.posterUri ?? null} />
      <View style={styles.meta}>
        ...
        <View style={styles.metaRow}>
          ...
          {typeof movie.rating === 'number' ? (
            <AppText tone="rating" variant="caption">
